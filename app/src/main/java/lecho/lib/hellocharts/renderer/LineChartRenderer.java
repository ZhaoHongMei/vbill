...
public class LineChartRenderer extends AbstractChartRenderer {
    ...
    private void drawSmoothPath(Canvas canvas, Line line) {
        ...
        float prePreviousPointX = 0.0F / 0.0f;
        float prePreviousPointY = 0.0F / 0.0f;
        float previousPointX = 0.0F / 0.0f;
        float previousPointY = 0.0F / 0.0f;
        float currentPointX = 0.0F / 0.0f;
        float currentPointY = 0.0F / 0.0f;
        float nextPointX = 0.0F / 0.0f;
        float nextPointY = 0.0F / 0.0f;
